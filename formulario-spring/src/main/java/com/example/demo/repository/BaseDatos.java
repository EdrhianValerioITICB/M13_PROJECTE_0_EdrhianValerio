...
public class BaseDatos {
	...
	public BaseDatos() {
		libros.add(new Libro(1, "HARRY POTTER Y EL PRISIONERO DE AZKABAN", "J.K ROWKINGS", "SALAMANDRA", "26/9/2006 0:00:00", "INFANTIL"));
		libros.add(new Libro(2, "EL GRAN LABERINTO", "FERNANDO SABATER PEREZ", "ARIEL", "26/9/2004 0:00:00", "FICCION"));
		libros.add(new Libro(3, "ROMEO Y JULIETA", "WILLIAM SHAKESPARE", "SALAMNDRA", "26/9/2006 0:00:00", "ROMANTICA"));
		libros.add(new Libro(4, "LA CARTA ESFERICA", "ARTURO PEREZ LOPEZ", "SALAMANDRA", "29/9/2004 0:00:00", "FICCION"));
		...
		libros.add(new Libro(7, "PROTOCOLO", "JOSE LOPEZ MURILLO", "SALAMANDRA","6/9/2006 0:00:00","CIENCIA"));
		libros.add(new Libro(8, "LINUX","FERNANDO SABATER PEREZ","ARIEL","7/9/2006 0:00:00","INFORMATICA"));
